...
function Hero() {
  ...
  return (
    <div className="pb-20 pt-36">
      <div>
        <Spotlight
          className="-top-40 -left-10 md:-left-32 md:-top-40 h-screen"
          fill="white"
        />
        <Spotlight
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:maxw-[60vw] flex flex-col items-center justify-center">
          ...
          <TextGenerateEffect
            ...
            words="Hi, I'm Abhradip Paul, a Full Stack Developer"
          />
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Next.js, React.js, Node.js, PostgreSQL, MySQL, MongoDB, Redis
          </p>
          <MagicButton
            icon={<FaLocationArrow />}
            position="right"
            handleClick={() => navigate.push("/projects")}
          >
            See my work
          </MagicButton>
        </div>
